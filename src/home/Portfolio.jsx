...
import Portfolio1 from '../assets/porfolio/cpoints.jpeg'
import Portfolio2 from '../assets/porfolio/portfolio-2.jpg'
...
function Portfolio() {
    return (
        <section id="portfolio" className="max-w-[1160px] w-full mx-auto mt-[168px]  px-[24px] lg:px-0 ">
            <h3 className="text-2xl text-[#C1C1C1]">PROJECTS</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-4 mt-[51px]">
                <div className="grid gap-4" >
                    <a href="https://shoe-website-iota.vercel.app/index.html" className="overflow-hidden rounded-lg" data-aos="fade-up" data-aos-duration="1000">
